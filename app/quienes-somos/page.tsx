  ...
  return (
    <>
      ...
      <main className="pt-[88px] lg:pt-[104px]">
        {/* ── HERO ── (split 7/5 con la foto del equipo como card a la
            derecha, mismo patrón visual que medicosinvirtiendo.cl) */}
        <section className="relative bg-[#2B2B2B] overflow-hidden">
          <div className="absolute -top-32 -left-32 w-[480px] h-[480px] bg-[#B67A2D]/15 rounded-full blur-[120px] pointer-events-none" />
          <div className="absolute -bottom-32 -right-32 w-[480px] h-[480px] bg-[#E8C28A]/10 rounded-full blur-[120px] pointer-events-none" />
          <div className="relative max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-8 py-14 md:py-24 grid grid-cols-1 md:grid-cols-12 items-center gap-10 md:gap-12">
            <div className="md:col-span-7">
              <p className="font-heading font-bold text-[11px] tracking-[4px] uppercase text-[#E8C28A] mb-4">
                Sobre nosotros
              </p>
              <h1 className="font-heading font-bold text-[28px] sm:text-[38px] md:text-[52px] text-white leading-[1.1] tracking-[-0.02em] mb-6">
                Especialistas en inversión que también{" "}
                <span className="text-[#E8C28A]">invertimos</span>.
              </h1>
              <p className="font-body text-[17px] md:text-[18px] text-white/80 leading-relaxed">
                Somos un equipo con más de 10 años en el mercado inmobiliario
                chileno: construcción, desarrollo, asesoría hipotecaria y
                gestión patrimonial. Acompañamos a profesionales de alta renta
                a tomar decisiones informadas y construir patrimonio con
                método. Más que asesores, somos tus amigos financieros.
              </p>
            </div>
            <div className="md:col-span-5 relative w-full">
              <div className="relative aspect-[5/4] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                <Image
                  src={STOCK.heroTeam}
